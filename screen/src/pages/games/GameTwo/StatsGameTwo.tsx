...
import ImagenFondoCalibration from "../../../assets/fondote.webp";
    ...
    return (
        <div className="flex items-center justify-center w-screen h-screen overflow-hidden">
            ...
            >
                ...
                >
                    <img fetchPriority="high" loading="eager" className="absolute scale-98 inset-0 w-full h-full object-cover" src={ImagenFondoCalibration} />
