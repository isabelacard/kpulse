    ...
    return (
        <div className="flex items-center justify-center w-full h-screen overflow-hidden bg-white">
            ...
            >
                ...
                >
                    <img fetchPriority="high" loading="eager" className="absolute w-full scale-98 h-full object-cover top-0 left-0 z-0" src={ImagenFondo} alt="Background" />
                    <img className="absolute z-10 w-200 right-140 top-20 scale-80" src={Pelota1} alt="Pelota" />
                    <img className="absolute z-10 w-120 left-195 top-40 scale-90" src={Celular1} alt="Celular" />
