...
export default function Formsfinal() {
    return (
        <div className="flex items-center justify-center w-full h-screen">
            <img fetchPriority="high" loading="eager" src={fondoform} alt="Group 12" className="w-full h-screen scale-104 object-contain z-0 absolute" />
            ...
            <div className="z-1 gap-0 md:gap-0 flex w-full flex-col items-center px-6 md:px-20 lg:px-42">
                ...
                <h2 className="text-white text-1xl md:text-2xl mt-1 md:mt-2 w-full md:w-200 font-medium text-center mb-2 md:mb-3 max-w-lg leading-tight">Click to start instructions.</h2>
