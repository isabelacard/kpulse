...
const options = [
    { label: "Recover strength", color: "bg-[#F88888]", icon: Square },
    { label: "Regain daily functionality", color: "bg-[#A6CFFF]", icon: Circle },
    { label: "Improve range of motion", color: "bg-[#E8D676]", icon: Triangle },
    { label: "Maintain current progress", color: "bg-[#F7A3FF]", icon: Star },
];
        ...
        <div className="flex items-center justify-center w-full h-screen">
            ...
            <div className="z-1 gap-6 md:gap-10 flex w-full flex-col items-center px-6 md:px-20 lg:px-42">
                ...
                <div className="absolute top-16 md:top-25 left-1/2 -translate-x-1/2 w-1/2 md:w-1/3 h-2 md:h-2.5 bg-white/30 rounded-full overflow-hidden">
                    <div className="h-full w-60 bg-yellow-200 rounded-full" />
                </div>

                {/* Pregunta */}
                <h1 className="text-white text-2xl md:text-4xl mt-16 md:mt-20 w-full md:w-100 font-medium text-center mb-2 md:mb-3 max-w-lg leading-tight">What is your main rehabilitation goal?</h1>
