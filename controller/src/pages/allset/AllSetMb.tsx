                ...
                <div className="flex flex-col items-center w-full mt-12">
                    ...
                    <div className="flex flex-col items-center justify-center w-full max-w-75 gap-6 mt-40">
                        <div className="flex items-center w-full bg-[#E5E5E5] rounded-full px-6 py-3">
                            ...
                            <input type="email" placeholder="E-mail" className="bg-transparent border-none outline-none text-gray-700 ml-3 w-full placeholder-gray-400 font-poppins text-lg" />
                        </div>

                        <button className="w-full bg-linear-to-r from-[#F5C768] to-[#E88610] text-black font-poppins font-medium rounded-full py-3 hover:opacity-90 transition-opacity text-lg">Send</button>
                    </div>
                </div>
