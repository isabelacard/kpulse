...
const options = [
    { color: "bg-[#F88888]", icon: Square, label: "Post-surgery recovery" },
    { color: "bg-[#A6CFFF]", icon: Circle, label: "Muscle or joint injury" },
    { color: "bg-[#E8D676]", icon: Triangle, label: "Neurological condition" },
    { color: "bg-[#F7A3FF]", icon: Star, label: "No diagnosed condition" },
];
        ...
        <div className="relative flex flex-col items-center w-full h-screen overflow-hidden font-sans cursor-pointer bg-center bg-size-[100%_100%] bg-no-repeat" style={{ backgroundImage: `url(${fondoform})` }}>
            <div className="z-10 flex flex-col items-center justify-between w-full h-full max-w-sm px-6 pb-6">
                ...
                <div className="flex-1 flex flex-col justify-center items-center w-full my-auto">
                    <h1 className="text-white text-[30px] font-medium text-center px-4 leading-tight">What is your current mobility condition?</h1>
