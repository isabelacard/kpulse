        ...
        <div className="relative flex flex-col items-center w-full min-h-screen bg- overflow-hidden font-sans">
            ...
            <div className="z-1">
                ...
                <div className="w-60 h-2 bg-gray-200 rounded-full mt-30 overflow-hidden mx-auto">
                    <div className="w-30 h-full bg-yellow-300 rounded-full" />
                </div>

                {/* Preguntapp */}
                <h1 className="text-white text-[35px] font-medium text-center px-12 mt-15 leading-tight">What is your main rehabilitation goal?</h1>
